...
public class Context {
    ...
    static {
        List<Row> best = new ArrayList<>();
        best.add(new Row("Nela", "Kuklake"));
        best.add(new Row("Zofia", "Mądra"));
        best.add(new Row("Stanisław", "Bogaty"));
        best.add(new Row("Antoni", "Utalentowany"));

        tables.put("Najlepsi", best);
    }
